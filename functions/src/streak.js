...
export const recordDailyLogin = onCall(async (request) => {
  ...
  try {
    ...
    if (result.milestoneReached === 3) {
      await sendFCMToUser(
        uid,
        "🔥 3 Day Streak!",
        "You earned a bonus spin ticket!",
        "streak",
      );
      ...
      await sendFCMToUser(
        uid,
        "🔥 7 Day Streak!",
        "You earned a bonus spin ticket and a payout boost!",
        "streak",
      );
      ...
      await sendFCMToUser(
        uid,
        "🔥 30 Day Streak!",
        "Incredible! You earned 2 bonus spin tickets and the Loyal Miner badge!",
        "streak",
      );
    }
